...
namespace Sales.Controllers
{
    public class SalesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SalesmanId,Amount,Date")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SalesmanId,Amount,Date")] Sale sale)
        {
            if (id != sale.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SalesContext.Sale'  is null.");
            }
            var sale = await _context.Sale.FindAsync(id);
            if (sale != null)
            {
